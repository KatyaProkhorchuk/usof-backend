                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="login">{{ trans('backpack::base.login') }}</label>

                            <div>
                                <input type="text" class="form-control{{ $errors->has('login') ? ' is-invalid' : '' }}" name="login" id="login" value="{{ old('login') }}">
